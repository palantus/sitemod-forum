const elementName = 'forum-new-thread-page'
...
template.innerHTML = `
  ...
  <action-bar id="action-bar" class="hidden">
    ...
    <action-bar-item id="publish-btn">Publish</action-bar-item>
...
class Element extends HTMLElement {
  ...
  async deletePage(){
    ...
    if(!await confirmDialog(`Are you sure that you want to delete this forum thread ${this.threadId}?`)) return;
